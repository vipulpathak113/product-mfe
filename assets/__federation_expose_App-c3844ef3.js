...
import { _ as __vitePreload } from './preload-helper-04e8c2b5.js';
...
'cart-mfe':{url:'https://vipulpathak113.github.io/cart-mfe/assets/cart-mfe-entry.js',format:'esm',from:'vite'}
                ...
                const wrapShareModule = remoteFrom => {
                    return {
                        'react':{'undefined':{get:()=>get(new URL('__federation_shared_react-2436d585.js', import.meta.url).href, remoteFrom), loaded:1}},'react-dom':{'undefined':{get:()=>get(new URL('__federation_shared_react-dom-6fc2ee8d.js', import.meta.url).href, remoteFrom), loaded:1}},'zustand':{'undefined':{get:()=>get(new URL('__federation_shared_zustand-28f60b29.js', import.meta.url).href, remoteFrom), loaded:1}}
                    }
                };
