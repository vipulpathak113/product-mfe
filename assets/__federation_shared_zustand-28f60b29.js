...
const createStoreImpl = (createState) => {
  ...
  const destroy = () => {
    if (({"VITE_CART_MFE_URL":"https://vipulpathak113.github.io/cart-mfe/assets/cart-mfe-entry.js","BASE_URL":"/product-mfe/","MODE":"production","DEV":false,"PROD":true,"SSR":false} ? "production" : void 0) !== "production") {
      console.warn(
...
function useStore(api, selector = api.getState, equalityFn) {
  if (({"VITE_CART_MFE_URL":"https://vipulpathak113.github.io/cart-mfe/assets/cart-mfe-entry.js","BASE_URL":"/product-mfe/","MODE":"production","DEV":false,"PROD":true,"SSR":false} ? "production" : void 0) !== "production" && equalityFn && !didWarnAboutEqualityFn) {
    console.warn(
...
const createImpl = (createState) => {
  if (({"VITE_CART_MFE_URL":"https://vipulpathak113.github.io/cart-mfe/assets/cart-mfe-entry.js","BASE_URL":"/product-mfe/","MODE":"production","DEV":false,"PROD":true,"SSR":false} ? "production" : void 0) !== "production" && typeof createState !== "function") {
    console.warn(
